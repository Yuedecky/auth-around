package com.broad.security.auth.core.validate.filter;
...
public class ValidateCodeFilter extends OncePerRequestFilter implements InitializingBean {
    ...
    public void afterPropertiesSet() throws ServletException {
        ...
        urlMap.put(AuthConstants.DEFAULT_LOGIN_PROCESSING_URL_FORM, ValidateCodeType.IMAGE);
        addUrlToMap(coreProperties.getCode().getImage().getUrl(), ValidateCodeType.IMAGE);
        urlMap.put(AuthConstants.DEFAULT_LOGIN_PROCESSING_URL_MOBILE, ValidateCodeType.SMS);
