...
public abstract class AbstractSessionStrategy implements InvalidSessionStrategy {
     ...
     */
    public void onSessionInvalidate(HttpServletRequest request, HttpServletResponse response) throws IOException {
        if (createNewSession) {
            request.getSession();
        }
